    ...
    <AuthenticatedLayout>
      ...
      <main
        ...
        <div className="relative p-6 bg-zinc-50 border border-zinc-300/90 overflow-hidden rounded-xs z-10 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
            ...
            {users.map((user, index) => (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-1.5 relative z-10 pl-2">
                  <div>
                    <h3 className="text-sm font-black text-zinc-800 uppercase tracking-widest group-hover:text-amber-900 transition-colors leading-none">{user.name}</h3>
                    <p className="text-[10px] text-zinc-400 uppercase tracking-widest mt-0.5 font-medium leading-tight">{user.email}</p>
                  </div>
                  <div className="text-[9px] font-bold text-amber-700 bg-amber-50/50 border border-amber-100/50 px-1.5 py-px flex items-center gap-1.5 shadow-sm">
                    ...
                    SYS_ID.{String(index + 1).padStart(3, '0')}
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center mt-auto pt-1.5 border-t border-zinc-100 relative z-10 pl-2">
                  ...
                  {canEdit && (
                    <Link
                      ...
                      // UPDATED BUTTON: Added bg-zinc-100, increased px-6 and py-1.5 to make it a larger, solid block without affecting the parent height.
          ...
          <div className="mt-6 pt-3 border-t border-zinc-300 text-center text-[9px] text-zinc-500 uppercase tracking-[0.2em]">
            // БЛОК_ПАГИНАЦИИ_ДОЛЖЕН_БЫТЬ_ЗДЕСЬ
          </div>
        </div>
      </main>
    </AuthenticatedLayout>
