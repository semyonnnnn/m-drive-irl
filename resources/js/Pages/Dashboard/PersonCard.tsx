    ...
    return (<div className="flex items-center gap-6 p-6 rounded-3xl bg-white/40 backdrop-blur-sm border border-white/20 shadow-sm hover:shadow-lg transition-all group">
        <div className="relative">
            <img
                src={url}
                alt={alt}
                className="select-none w-24 h-24 rounded-full object-cover relative z-10 border-4 border-white shadow-md"
            />
        ...
        <div className="flex-1">
            ...
            <button className="select-none flex items-center gap-2 px-4 py-1.5 bg-surface-container text-on-surface-variant rounded-xl text-xs font-bold transition-all hover:bg-surface-container-high font-headline">
...
const Extra = () => {
    return (
        <div className="select-none flex items-center justify-center p-6 rounded-3xl border-2 border-dashed border-surface-container-highest bg-white/20 hover:bg-white/40 transition-colors cursor-pointer">
