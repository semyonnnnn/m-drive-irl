...
const PersonCard = ({ url, name, alt, info }: PersonCardProps) => {
    return (
        ...
        >
            ...
            <div className="relative p-5 w-fit bg-zinc-50 border border-zinc-300 outline-1 outline-transparent -outline-offset-1 transition-all duration-200 group-hover:border-blue-600 group-hover:bg-blue-50/30 group-hover:shadow-[0_0_12px_rgba(8,145,178,0.1)] clip-corner">
                ...
                <div className="flex items-center gap-5 relative z-10">
                    ...
                    <div className="relative shrink-0">
                        <div className="w-20 h-20 bg-zinc-200 border-2 border-zinc-400 p-1 group-hover:border-blue-600 transition-colors">
                            <img
                                src={url}
                                alt={alt}
                        ...
                        <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-zinc-100 border-2 border-zinc-50 group-hover:bg-blue-600 transition-colors flex items-center justify-center">
                    ...
                    <div className="flex-1 min-w-0 font-mono">
                        <div className="flex items-center justify-between gap-2 mb-1">
                            <p className="text-md font-bold uppercase tracking-wider text-zinc-900 group-hover:text-blue-700 transition-colors truncate">
                                {name}
                            </p>
                            <span className="text-[9px] text-zinc-400 group-hover:text-blue-600 font-black tracking-widest uppercase shrink-0">
                                [ {alt} ]
                            </span>
                        </div>
...
const Extra = () => {
    return (
        ...
        <div className="select-none font-mono relative p-4 w-fit max-w-xs flex flex-col justify-between bg-zinc-100/60 border border-dashed border-zinc-300 hover:border-blue-600 hover:bg-blue-50/20 transition-all duration-200 cursor-pointer group clip-corner">
            ...
            <div className="flex items-start justify-between gap-6 w-full relative z-10 mb-3">
                <div className="flex items-center gap-2">
                    <p className="text-xs font-bold uppercase tracking-widest text-zinc-700 group-hover:text-blue-600 transition-colors whitespace-nowrap">
                        Пригласить коллегу
                    </p>
                </div>
            ...
            <div className="border-t border-zinc-200 pt-2 flex items-center justify-between gap-4 relative z-10">
                <p className="text-[9px] text-blue-600 font-black uppercase tracking-widest group-hover:text-blue-700">
                    // 3 СВОБОДНЫХ МЕСТА
                </p>
                {/* Small UI micro-pips simulating hardware nodes */}
                <div className="flex gap-1 shrink-0">
                    <div className="w-2 h-1 bg-blue-600/30 group-hover:bg-blue-600 transition-colors"></div>
                    <div className="w-2 h-1 bg-blue-600/30 group-hover:bg-blue-600 transition-colors"></div>
                    <div className="w-2 h-1 bg-blue-600/30 group-hover:bg-blue-600 transition-colors"></div>
                </div>
            </div>
