...
type registerOrLoginType = 'register' | 'login' | null;
...
export default function Guest({ header, children }: PropsWithChildren<{ header?: ReactNode }>) {
    ...
    const handleSetRegisterOrLogin = (str: registerOrLoginType) => {
        setRegisterOrLogin(str);
    };
                    ...
                    <div className="flex h-16 justify-between">
                        ...
                        <div className="hidden sm:ms-6 sm:flex sm:items-center gap-10">
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent>
                                    <RegisterDialog onClick={handleSetRegisterOrLogin} />
                                    <LoginDialog onClick={handleSetRegisterOrLogin} />
                                </DropdownMenuContent>
                            </DropdownMenu>
                        </div>
